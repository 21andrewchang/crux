...
struct QuizView: View {
    ...
    static let questions: [Question] = [
        ...
        // strengths screen a relief rather than a boast.
        .init(id: "weaknesses", title: "Your weaknesses",
              options: attributes, allowsMultiple: true),
    ...
    private func row(_ option: String) -> some View {
        let isChosen = chosen.contains(option)
        ...
        .overlay(RoundedRectangle(cornerRadius: 14)
            .stroke(.white, lineWidth: isChosen ? 1.5 : 0))
        .contentShape(.rect)
    }
